    ...
    <div class="expandable-box">
      ...
      <div class="expandable-body">
        <div class="field">
          ...
          <input class="widefat cycloneslider-slide-button-cta" name="cycloneslider_metas[<?php echo esc_attr($i); ?>][button_img_cta]" type="text" value="<?php echo esc_attr($slide['button_img_cta']); ?>" />
        </div>
        <div class="field last">
          <label for=""><?php _e('Button URL:', 'cycloneslider'); ?></label> <br>
          <input class="widefat cycloneslider-slide-button-url" name="cycloneslider_metas[<?php echo esc_attr($i); ?>][button_img_url]" type="text" value="<?php echo esc_attr($slide['button_img_url']); ?>" />
        </div>
      </div>
    </div>
