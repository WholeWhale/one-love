...
if ( 'yes' === $atts['show_filter'] && ! empty( $filter_terms ) ) :
    ...
    if ($atts['filter_sort'] == 'term_id')
      usort($terms,"compare_term_id");
    elseif ( $atts['filter_sort'] == 'description' )
      usort($terms,"compare_description");
    if ( $atts['filter_orderby'] == 'des' )
      rsort($terms);
