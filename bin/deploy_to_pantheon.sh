...
SLACK_MESSAGE="Circle CI build ${CIRCLE_BUILD_NUM} by ${CIRCLE_PROJECT_USERNAME} was successful and has been deployed to Pantheon in the dev environment! \n<https://dev-$PANTHEON_SITE_NAME.pantheonsite.io/|View dev site> | <https://dashboard.pantheon.io/sites/${PANTHEON_SITE_UUID}#dev/code|View on Pantheon Dashboard>"
