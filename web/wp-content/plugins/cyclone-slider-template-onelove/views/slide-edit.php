...
<div class="cs-slide" data-slide-type="<?php echo esc_attr( $slide['type'] ); ?>" data-slide-hidden="<?php echo esc_attr( $slide['hidden'] ); ?>">
	...
	<div class="cs-body">
		...
		?>
		<?php $this->render(
			ONELOVE_VIEWS_DIR.'slide-edit-image.php',
			array(
				'i' => $i,
                'slide' => $slide,
                'image_url' => $image_url,
      ...
      <div class="expandable-box">
        <div class="expandable-header first"><?php _e('Button', 'cycloneslider'); ?></div>
        <div class="expandable-body">
          <div class="field">
            <label for=""><?php _e('Button Text:', 'cycloneslider'); ?></label> <br>
            <input class="widefat cycloneslider-slide-button-cta" name="cycloneslider_metas[<?php echo esc_attr($i); ?>][button_cta]" type="text" value="<?php echo esc_attr($slide['button_cta']); ?>" />
          </div>
          <div class="field last">
            <label for=""><?php _e('Button URL:', 'cycloneslider'); ?></label> <br>
            <input class="widefat cycloneslider-slide-button-url" name="cycloneslider_metas[<?php echo esc_attr($i); ?>][button_url]" type="text" value="<?php echo esc_attr($slide['button_url']); ?>" />
          </div>
        </div>
      </div>
      <div class="expandable-box">
        <div class="expandable-header first"><?php _e('Fallback Image', 'cycloneslider'); ?></div>
        <div class="expandable-body">
          <div class="field last">
